  ...
  actions: {
    ...
    async createGroup(payload) {
      ...
      try {
        ...
        console.error('Create group response:', JSON.stringify(error.response?.data, null, 2))
    ...
    async updateGroup(id, payload) {
      ...
      try {
        ...
        console.error('Update group response:', JSON.stringify(error.response?.data, null, 2))
    ...
    async uploadGroupThumbnail(id, file) {
      ...
      try {
        ...
        console.error('Upload group thumbnail response:', JSON.stringify(error.response?.data, null, 2))
